...
public partial class Course
{
    ...
    public void DessinerParcours()
    {
        ...
        else
        {
            ...
            else if ((metreCompteur / 100) >= 1) ligneMetre = "│ " + metreCompteur + "  mètres │";
            else if ((metreCompteur / 10) >= 1) ligneMetre = "│ " + metreCompteur + "   mètres │";
            ...
            if ((tempsEntreDebut.TotalSeconds / 100) >= 1) ligneMetre = "│ " + tempsEntreDebut.TotalSeconds.ToString("F1") + "  sec.  │";
            else if ((tempsEntreDebut.TotalSeconds / 10) >= 1) ligneMetre = "│ " + tempsEntreDebut.TotalSeconds.ToString("F1") + " sec.   │";
            else ligneMetre = "│ " + tempsEntreDebut.TotalSeconds.ToString("F2") + " sec.   │";
            Console.WriteLine(ligneMetre);
    ...
    public void DialogueDeFinDePartie()
    {
        ...
        if ((tempsEntreDebut.TotalSeconds / 100) >= 1) ligneMetre = "║ Durée: " + tempsEntreDebut.TotalSeconds.ToString("F1") + "  sec. ║";
